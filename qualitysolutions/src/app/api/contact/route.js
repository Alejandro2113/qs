...
export async function POST(request) {
  ...
  try {
    ...
    await transporter.sendMail({
        ...
        html: `
         <html>
  <body style="font-family: 'Arial', sans-serif; background: linear-gradient(to right, #000000, #0000ff, #ffffff); margin: 0; padding: 0;">
    <div style="max-width: 600px; margin: 20px auto; background-color: #ffffff; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); overflow: hidden;">
      <header style="background-color: #333333; padding: 20px; text-align: center;">
        ...
        <table style="width: 100%; border-collapse: collapse; font-size: 16px; color: #333;">
          <thead>
            <tr style="background-color: #444444;">
              <th style="text-align: left; padding: 12px; border-bottom: 2px solid #ddd; font-weight: bold; color: #ffffff;">Campo</th>
              <th style="text-align: left; padding: 12px; border-bottom: 2px solid #ddd; font-weight: bold; color: #ffffff;">Detalle</th>
            </tr>
          </thead>
          <tbody>
      ...
      <footer style="background-color: #333333; color: #ffffff; text-align: center; padding: 15px;">
